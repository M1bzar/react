...
const DatosApi = ({ navigation }) => { // Pass the navigation prop
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.heading}>Mexican Peso VS USA dollar</Text>
            ...
            {jsonData.map((item, index) => (
                Object.keys(item).length > 0 && (
                    <View key={index} style={styles.dataRow}>
                        ...
                        <Text><Image source={require("../img/usa.png")} style={{ width: 30, height: 20 }}/> US dollar: {item["US dollar"]}</Text>
                    </View>
                )
            ))}
