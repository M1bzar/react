...
const DatosApi2 = ({ navigation }) => { // Pass the navigation prop
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.heading}>Mexican Peso VS Australian dollar Comparing with USA dollar</Text>
            ...
            {jsonData.map((item, index) => (
                Object.keys(item).length > 0 && (
                    <View key={index} style={styles.dataRow}>
                        ...
                        <Text><Image source={require("../img/aus.png")} style={{ width: 30, height: 20 }}/> Australian dollar: {item["Australian dollar"]}</Text>
                    </View>
                )
            ))}
