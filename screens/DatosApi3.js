...
const DatosApi3 = ({ navigation }) => { // Pass the navigation prop
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.heading}>Mexican Peso VS Canadian dollar Comparing With USA dollar</Text>
            ...
            {jsonData.map((item, index) => (
                Object.keys(item).length > 0 && (
                    <View key={index} style={styles.dataRow}>
                        ...
                        <Text><Image source={require("../img/can.png")} style={{ width: 30, height: 20 }}/> Canadian dollar: {item["Canadian dollar"]}</Text>
                    </View>
                )
            ))}
