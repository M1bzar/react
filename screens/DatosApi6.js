...
const DatosApi6 = ({ navigation }) => { // Pass the navigation prop
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.heading}>Mexican Peso VS UK Turkish lira Comparing with USA dollar</Text>
            ...
            {jsonData.map((item, index) => (
                Object.keys(item).length > 0 && (
                    <View key={index} style={styles.dataRow}>
                        ...
                        <Text><Image source={require("../img/tur.png")} style={{ width: 30, height: 20 }}/> Turkish lira: {item["Turkish lira"]}</Text>
                    </View>
                )
            ))}
